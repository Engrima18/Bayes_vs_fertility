...
The Bayesian logistic regressin model defines the distribution of the output variable as a Bernullian of parameter $p$ (mean of the distribution) in particular implies the following parameterization and prior distributions of the parameters:
...
mu_0 <- 0
sig_0 <- 1.0E-6
N <- dim(Fertility.data)[1]

dd <- list("Y" = Fertility.data$Out,
           "Season"= Fertility.data$Season,
           "Age"= Fertility.data$Age,
           "Disease"= Fertility.data$Disease,
           "Accident"= Fertility.data$Accident,
           "Surgery"= Fertility.data$Surgery,
           "Fever"= Fertility.data$Fever,
           "Alcohol"= Fertility.data$Alcohol,
           "Smoking"= Fertility.data$Smoking,
           "Sedentarity"= Fertility.data$Sedentarity,
           "N" = N, "mu_0" = mu_0, "sig_0"= sig_0)

params <- c("p","beta0", "beta1", "beta2", "beta2", "beta3", "beta4", "beta5",
            "beta6", "beta7", "beta8", "beta9")

inits <- list(list("beta0" = 0, "beta1" = 0, "beta2" = 0, "beta3" = 0,
                   "beta4" = 0, "beta5" = 0, "beta6" = 0, "beta7" = 0, "beta8" = 0, "beta9" = 0),
              list("beta0" = 0.1, "beta1" = 0.1, "beta2" = 0.1, "beta3" = 0.1, "beta4" = 0.1,
                   "beta5" = 0.1, "beta6" = 0.1, "beta7" = 0.1, "beta8" = 0.1, "beta9" = 0.1),
              list("beta0" = 0.2, "beta1" = 0.2, "beta2" = 0.2, "beta3" = 0.2, "beta4" = 0.2,
                   "beta5" = 0.2, "beta6" = 0.2, "beta7" = 0.2, "beta8" = 0.2, "beta9" = 0.2))
...
# Get only beta parameters
betas <- mcmc_samples[, grep("^beta", varnames(mcmc_samples))]
